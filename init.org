#+BEGIN_COMMENT 
Fetaure list to be enabled in that order
Order of execution
| Feature | eval    | status  |
| Ecoding | default | enabled |
...
#+HTML_HEAD: <style> pre.src{ z-index: -1; } </style>
...
;;  (add-to-list 'load-path "/usr/share/org-mode/lisp/")
  (add-to-list 'load-path "/home/sameer/.emacs.d/site-lisp/org/")
#+END_SRC
** ELPA
#+BEGIN_SRC emacs-lisp
(require 'package)
